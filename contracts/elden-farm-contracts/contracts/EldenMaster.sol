...
/*
 * This contract centralizes Elden's yield incentives distribution.
 ...
 */
contract EldenMaster is Ownable, IEldenMaster {
  ...
  constructor(
    ...
    require(address(eldenToken_) != address(0), "EldenMaster: eldenToken cannot be set to zero address");
    require(_currentBlockTimestamp() < startTime_ && startTime_ >= eldenToken_.lastEmissionTime(), "EldenMaster: invalid startTime");
   ...
   */
  function owner() public view virtual override(IEldenMaster, Ownable) returns (address) {
