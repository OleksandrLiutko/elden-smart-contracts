...
import '@elden/v3-periphery/contracts/base/PeripheryImmutableState.sol';
import '@elden/v3-core/contracts/libraries/SafeCast.sol';
import '@elden/v3-core/contracts/libraries/TickMath.sol';
import '@elden/v3-core/contracts/libraries/TickBitmap.sol';
...
import '@elden/v3-periphery/contracts/libraries/Path.sol';
...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, IEldenV3SwapCallback, PeripheryImmutableState {
    ...
    */
    ...
    /// @inheritdoc IEldenV3SwapCallback
    function eldenV3SwapCallback(
        ...
        IEldenV3Pool pool = SmartRouterHelper.getPool(deployer, tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IEldenV3Pool pool = SmartRouterHelper.getPool(deployer, params.tokenIn, params.tokenOut, params.fee);
