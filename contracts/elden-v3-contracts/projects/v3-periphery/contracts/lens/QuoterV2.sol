...
contract QuoterV2 is IQuoterV2, IEldenV3SwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IEldenV3Pool) {
        return IEldenV3Pool(PoolAddress.computeAddress(deployer, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }
    ...
    function eldenV3SwapCallback(
        ...
        IEldenV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IEldenV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
