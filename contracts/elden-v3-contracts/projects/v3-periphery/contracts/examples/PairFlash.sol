...
import '@elden/v3-core/contracts/interfaces/callback/IEldenV3FlashCallback.sol';
...
/// @notice An example contract using the EldenSwap V3 flash function
contract PairFlash is IEldenV3FlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `EldenV3FlashCallback`
