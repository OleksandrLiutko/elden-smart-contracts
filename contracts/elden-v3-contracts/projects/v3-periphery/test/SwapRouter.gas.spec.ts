...
import { IEldenV3Pool, IWETH9, MockTimeSwapRouter, TestERC20 } from '../typechain-types'
...
describe('SwapRouter gas tests', function () {
  ...
  const swapRouterFixture: Fixture<{
    ...
    pools: [IEldenV3Pool, IEldenV3Pool, IEldenV3Pool]
    ...
    const pools = poolAddresses.map((poolAddress) => new ethers.Contract(poolAddress, IEldenV3PoolABI, wallet)) as [
      IEldenV3Pool,
      IEldenV3Pool,
      IEldenV3Pool
    ]
  ...
  let pools: [IEldenV3Pool, IEldenV3Pool, IEldenV3Pool]
  ...
  describe('#exactInput', () => {
    ...
    it.skip('0 -> 1 minimal', async () => {
      const calleeFactory = await ethers.getContractFactory('TestEldenV3Callee')
