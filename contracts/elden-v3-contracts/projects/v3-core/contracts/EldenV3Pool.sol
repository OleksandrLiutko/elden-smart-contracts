...
import './interfaces/IEldenV3Factory.sol';
...
import './interfaces/IEldenV3LmPool.sol';

contract EldenV3Pool is IEldenV3Pool {
    ...
    /// @inheritdoc IEldenV3PoolImmutables
    ...
    modifier onlyFactoryOrFactoryOwner() {
        require(msg.sender == factory || msg.sender == IEldenV3Factory(factory).owner());
        _;
    }

    constructor() {
        int24 _tickSpacing;
        (factory, token0, token1, fee, _tickSpacing) = IEldenV3PoolDeployer(msg.sender).parameters();
    ...
    /// @inheritdoc IEldenV3PoolDerivedState
    ...
    /// @inheritdoc IEldenV3PoolActions
    ...
    function mint(
        ...
        IEldenV3MintCallback(msg.sender).eldenV3MintCallback(amount0, amount1, data);
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            IEldenV3SwapCallback(msg.sender).eldenV3SwapCallback(amount0, amount1, data);
    ...
    function flash(
        ...
        IEldenV3FlashCallback(msg.sender).eldenV3FlashCallback(fee0, fee1, data);
    ...
    /// @inheritdoc IEldenV3PoolOwnerActions
