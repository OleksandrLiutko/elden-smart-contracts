...
import { EldenV3PoolSwapTest } from '../typechain-types/contracts/test/EldenV3PoolSwapTest'
...
describe('EldenV3Pool arbitrage tests', () => {
      ...
      for (const passiveLiquidity of [
        ...
        describe(`passive liquidity of ${formatTokenAmount(passiveLiquidity)}`, () => {
          const arbTestFixture = async ([wallet, arbitrageur]: Wallet[]) => {
            ...
            const testerFactory = await ethers.getContractFactory('EldenV3PoolSwapTest')
            const tester = (await testerFactory.deploy()) as EldenV3PoolSwapTest
          ...
          let tester: EldenV3PoolSwapTest
