...
import "./EldenStableSwapTwoPool.sol";

contract EldenStableSwapTwoPoolDeployer is Ownable {
    ...
    function createSwapPair(
        ...
        bytes memory bytecode = type(EldenStableSwapTwoPool).creationCode;
        ...
        EldenStableSwapTwoPool(swapContract).initialize(coins, _A, _fee, _admin_fee, _admin, _LP);
