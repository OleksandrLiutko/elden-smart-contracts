...
import "./EldenStableSwapLP.sol";

contract EldenStableSwapLPFactory is Ownable {
    ...
    function createSwapLP(
        ...
        // create LP token
        bytes memory bytecode = type(EldenStableSwapLP).creationCode;
        ...
        EldenStableSwapLP(lpToken).setMinter(_minter);
