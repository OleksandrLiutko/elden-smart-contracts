...
import "./interfaces/IEldenStableSwap.sol";
import "./interfaces/IEldenStableSwapLP.sol";
import "./interfaces/IEldenStableSwapDeployer.sol";
import "./interfaces/IEldenStableSwapLPFactory.sol";

contract EldenStableSwapFactory is Ownable {
    ...
    IEldenStableSwapLPFactory public immutable LPFactory;
    IEldenStableSwapDeployer public immutable SwapTwoPoolDeployer;
    IEldenStableSwapDeployer public immutable SwapThreePoolDeployer;
     ...
     */
    constructor(
        IEldenStableSwapLPFactory _LPFactory,
        IEldenStableSwapDeployer _SwapTwoPoolDeployer,
        IEldenStableSwapDeployer _SwapThreePoolDeployer
    ) {
    ...
    function createSwapPair(
        ...
        IEldenStableSwapLP(LP).setMinter(swapContract);
    ...
    function addPairInfo(address _swapContract) external onlyOwner {
        IEldenStableSwap swap = IEldenStableSwap(_swapContract);
