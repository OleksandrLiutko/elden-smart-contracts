...
import "./EldenStableSwapThreePool.sol";

contract EldenStableSwapThreePoolDeployer is Ownable {
    ...
    function createSwapPair(
        ...
        bytes memory bytecode = type(EldenStableSwapThreePool).creationCode;
        ...
        EldenStableSwapThreePool(swapContract).initialize(coins, _A, _fee, _admin_fee, _admin, _LP);
